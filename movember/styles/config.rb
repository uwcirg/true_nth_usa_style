...
# CSS SPLITTER
#-----------------------------------------------------------
# This is a compass extension to cope with the 4096 selectors limit of Internet Explorer 9<
# It will output main.css - main_2.css - main_3.css etc...
...
# --------- Enable the CSS splitter plugin: --------- # 
